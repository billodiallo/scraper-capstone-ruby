...
RSpec.describe Scraper do
  ...
  describe '#bio' do
    it 'should get scrapped bio and set it to user bio' do
      ...
      expect(result).to eq('Full stack Web Developer
            HTML & CSS ,Ruby on Rails, JavaScript and React) and Cloud Computing, AWS.')
    end
  end
  ...
  describe '#profile_info' do
    ...
    it 'returned array should include user info' do
      ...
      expect(result).to include('Full STACK')
    end
  end
  ...
  describe '#page' do
    ...
    it 'returned array should include category items' do
      ...
      expect(result).to include('TNW-Project')
    end
  end
